...
<head>
  ...
  <title>IEQ | <?php echo $_SESSION['StockPower']['user']; ?></title>
  <!-- Icone -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo BASE_URL; ?>" class="logo">
      ...
      <span class="logo-mini"><b>IEQ</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>IEQ </b>CADMEMBRO</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="info">
          <p><?php echo $_SESSION['StockPower']['user']; ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo ($viewData['menuActive']=='membros')?'active':''; ?>"><a href="<?php echo BASE_URL ?>membros"><i class="fa fa-list-alt"></i> <span>Ficha de Membros</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      <strong style="text-transform: uppercase;">IEQ CADMEMBRO</strong>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="" target="_blank">Marcelo Cardoso</a>.</strong> Todos os Direitos Reservados.
  </footer>
